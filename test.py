...
if __name__ == "__main__":
    ...
    parser.add_argument("--weights_path", type=str, default="checkpoints1/yolov3_ckpt_920.pth", help="path to weights file")
    ...
    for i, c in enumerate(ap_class):
        print(f"+ Class '{c}' ({class_names[c]}) - AP: {AP[i]} -Recall: {recall[i]} -f1: {f1[i]}")
